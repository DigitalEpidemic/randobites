...
describe('BlacklistService', () => {
  ...
  describe('reportRestaurant', () => {
    it('should accept restaurant details and not throw', async () => {
      await expect(
        BlacklistService.reportRestaurant('test-id', 'Test Restaurant', 'Does not exist')
  ...
  describe('filterBlacklistedRestaurants', () => {
    it('should filter out blacklisted restaurants from a list', async () => {
      ...
      const filtered = await BlacklistService.filterBlacklistedRestaurants(restaurants);
  ...
  describe('clearLocalBlacklist', () => {
    it('should execute without throwing', async () => {
      await expect(BlacklistService.clearLocalBlacklist()).resolves.not.toThrow();
    });
  });
